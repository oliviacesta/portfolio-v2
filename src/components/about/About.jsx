        ...
        <div className="about__content">
          <div className="about__cards">
            <article className='about__card'>
              ...
              <h5>Experience</h5>
              <small>Previous co-ops: Software Development Intern x2, DevOps Intern, ML Research Assistant & QA Automation Specialist</small>
            </article>
            <article className='about__card'>
              <FiUsers className='about__icon'/>
              <h5>Interests</h5>
              <small>•Sports Analytics •Medical Technology •Cybersecurity •Machine Learning Research</small>
            </article>
            <article className='about__card'>
